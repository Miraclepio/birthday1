...
const router = express.Router()
    const {signUpUser,verifyUser, resendVerification,login,getOneUser,getAllUsers,deleteUser, updateUser} = require('../controller/userController')
...
router.route("/user/:id").put(authenticator,checkAdmin,validateObjectId,updateUser) 
